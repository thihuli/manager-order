...
import { INSTRUMENTS, OrderSide } from "../constants";
...
interface CreateOrderFormProps {
  ...
  onCreateOrder: (values: OrderFormValues) => Promise<boolean | void>;
}
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value={OrderSide.BUY}>{OrderSide.BUY}</SelectItem>
                      <SelectItem value={OrderSide.SELL}>{OrderSide.SELL}</SelectItem>
                    </SelectContent>
                  </Select>
                  <FormMessage />
                </FormItem>
